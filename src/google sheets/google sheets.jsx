...
function read_habits(doc_id) {
  return new Promise(async (resolve, reject) => {
    ...
    fetch(`https://sheets.googleapis.com/v4/spreadsheets/${doc_id}/values/${"Main!C1:Z1"}?valueRenderOption=FORMATTED_VALUE`, {
      method: 'GET',
      headers: {
        Authorization: `Bearer ${accessToken}`,
      },
      ...
      .then((response) => response.json())
      .then((data) => {
        console.log('Habits', data.values);
        resolve(data.values)
      })
      .catch((error) => {
...
const sheets = { listMajors, drive_setup, read_habits,log_entry }
